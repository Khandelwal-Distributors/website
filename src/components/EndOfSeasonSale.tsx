        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-16">
          ...
          <Card className="lg:col-span-4 bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
            ...
            <CardContent className="space-y-6">
              ...
              <Button variant="cta" size="lg" className="w-full" onClick={() => window.open('tel:+919084417884', '_self')}>
          ...
          <Card className="lg:col-span-4 bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
            ...
            <CardContent className="space-y-3">
              ...
              <Button variant="cta" size="lg" className="w-full mt-6" onClick={() => window.open('tel:+919084417884', '_self')}>
                <Phone className="h-5 w-5" />
                Get Instant Quote
              </Button>
            </CardContent>
