                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
                        {features.map((f, i) => (
                            <div
                                key={f.label}
                                className={`rounded-xl p-3.5 border transition-all duration-500 cursor-default ${i === active
                            ...
                            >
                                ...
                                <p
                                    className={`text-xs font-bold mt-2 leading-tight transition-colors ${i === active ? "text-blue-300" : "text-white"
                                        }`}
                                >
                                    {f.label}
                                </p>
