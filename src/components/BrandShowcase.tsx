        ...
        >
          {brands.map((brand, index) => (
            <Link key={index} to={brand.link || "#"} className="flex-shrink-0">
              <Card 
                className={`group hover:shadow-[var(--shadow-card)] transition-all duration-300 hover:-translate-y-2 overflow-hidden cursor-pointer animate-scale-in w-48 border ${
                  brand.featured 
                    ? 'border-primary border-2 bg-gradient-to-br from-primary/5 to-primary/10 shadow-lg shadow-primary/20' 
