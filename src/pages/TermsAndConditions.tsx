          ...
          <Card className="max-w-4xl mx-auto p-8">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  <strong className="text-foreground">3.3 Order Cancellation:</strong> You may cancel your order by calling us at <a href="tel:+917017497935" className="text-primary hover:underline">+91 7017497935</a> before the product is dispatched or installation begins. Cancellation requests must be confirmed by our customer service team.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  <strong className="text-foreground">5.3 Rental Cancellation:</strong> You may cancel your rental service by calling us at <a href="tel:+917017497935" className="text-primary hover:underline">+91 7017497935</a> with appropriate notice. Early cancellation may be subject to charges as per the rental agreement.
                </p>
                <p>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  <strong className="text-foreground">6.2 Service Support:</strong> We provide authorized service support for all brands we represent. Service requests can be made by calling our customer service at <a href="tel:+917017497935" className="text-primary hover:underline">+91 7017497935</a>.
                </p>
                <p>
            ...
            <section className="mb-8">
              ...
              <div className="text-muted-foreground leading-relaxed space-y-2">
                ...
                <div className="pl-4 space-y-1">
                  <p><strong className="text-foreground">Phone:</strong> <a href="tel:+917017497935" className="text-primary hover:underline">+91 7017497935</a></p>
